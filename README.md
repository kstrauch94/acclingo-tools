...
To create the acclingo job and run scripts templates are used. Default templates can be found in the create/templates folder. Of course, you can create your own templates and pass them to the script for use. The only requirement is that the acclingo template has a "{ptoa}" somewhere in the text.
...
The evaluation tool works for OPTIMIZATION problems. 
